  ...
  return (
    ...
    <div className="block relative outline outline-4 outline-orange-600 text-center bg-slate-300" id="drum-machine">
        <div className='inline-block m-5' style={{width:"332px", height:"272px"}} id="pad-bank">
            {drums.map((d) => {return (
                <div className="drum-pad relative float-left mt-2.5 mr-2.5 rounded-md pt-8 border-box cursor-pointer bg-gray-500 shadow-md shadow-black" key={d.id} id={d.id} style={{width: "100px", height: "80px"}} onClick={e => playSound(e)}>
