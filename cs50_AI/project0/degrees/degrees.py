...
def shortest_path(source, target):
    ...
    loop until a solution is found
        ...
        if nothing in the frontier then no solution

        check if frontier has target then we have a solution
        ...
        check if any new neighbours are already in the frontier, if so remove them from end of list.
